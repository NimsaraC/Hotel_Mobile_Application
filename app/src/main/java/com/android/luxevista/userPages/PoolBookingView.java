...
public class PoolBookingView extends AppCompatActivity {

    private TextView txtBookingId, txtServiceType, txtDate, txtCapacity, txtPrice, txtServiceId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pool_booking_view);
    ...
    private void navButtons() {
        ...
        btnProfile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PoolBookingView.this, ProfilePage.class);
    ...
    private void cancelButton() {
        btnCancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(PoolBookingView.this);
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        sharedPreference.clearPref(PoolBookingView.this);
    ...
    private void setServiceData() {
        ...
        txtCapacity.setText(String.format("%s Guests", booking.getCapacity()));
